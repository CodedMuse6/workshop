...
export const sendFeedbackLink = functions.https.onCall(async(data:functions.https.CallableRequest<FeedbackData>,context) => {
    ...
    try{
      ...
      throw new functions.https.HttpsError("internal", "Failed to send feddback link.")
    }
